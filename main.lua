...
-- CONFIG
---------------------------------------------------------
local RAW_LINK = "TWÓJ_RAW_TUTAJ"  -- <<< TU WSTAWIASZ RAW
...
local implementBtn = createButton("IMPLEMENT THIS SCREEN", Color3.fromRGB(255,170,0), 0.60)
...
local function createWindow()
    ...
    win.Size = UDim2.new(0.40,0,0.40,0)   -- <<< MNIEJSZE OKNO
...
devTab.Text = "Info for Devs"   -- <<< ZMIANA
...
codeBox.Text = 'loadstring("'..RAW_LINK..'")()'
